...
public class medicineReportContract {

    private medicineReportContract() {}
    ...
    public static final String PATH_VEHICLE = "report-path";

    public static final class medicineReportEntry implements BaseColumns {
        ...
        // CONTENT_URI = content://com.example.knight.a2018_mobile/report-path
