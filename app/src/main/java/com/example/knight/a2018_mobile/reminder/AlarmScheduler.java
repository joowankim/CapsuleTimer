...
//        PendingIntent for_check = PendingIntent.getBroadcast(context, 1, check_intent, 0);
        ...
        if (Build.VERSION.SDK_INT >= 23) {
           ...
           // checkManager.setExact(AlarmManager.RTC_WAKEUP, alarmTime, for_check);
        } else {
...
//        PendingIntent for_check = PendingIntent.getBroadcast(context, 1, check_intent, 0);
      ...
      //  checkManager.setRepeating(AlarmManager.RTC_WAKEUP, alarmTime,RepeatTime, for_check);
