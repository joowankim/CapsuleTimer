...
public class writing_memo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        memo_image = (ImageView)findViewById(R.id.memo_image);
        memo_content = (EditText)findViewById(R.id.memo_content);
        memo_submit = (Button)findViewById(R.id.memo_upload);

        /**
         * @description add button event click listener
         */
        memo_image.setOnClickListener(new View.OnClickListener() {
            @Override
         ...
         * @description add button event click listener
         */
        memo_submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    ...
                    String memo_text = memo_content.getText().toString();  // Get memo text from edit text widget
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        if (requestCode == PICK_IMAGE) {
            try {
                ...
                memo_image.setImageBitmap(MediaStore.Images.Media.getBitmap(this.getContentResolver(), selectedimg));  // Change image view which is selected by gallery
            }catch (Exception e){
                Toast.makeText(getApplicationContext(), "Error", Toast.LENGTH_LONG).show();
